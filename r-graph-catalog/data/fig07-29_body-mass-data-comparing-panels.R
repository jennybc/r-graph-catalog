...
my_data_men_long <- melt(my_data_men, id = "bmi",
                         variable.name = "risk_grp", value.name = "rrod")
my_data_women_long <- melt(my_data_women, id = "bmi",
                           variable.name = "risk_grp", value.name = "rrod")
...
p1 <- ggplot(my_data_men_long, aes(x = bmi, y = rrod, group = risk_grp)) +
...
p2 <- ggplot(my_data_women_long, aes(x = bmi, y = rrod, group = risk_grp)) +
  geom_line(aes(linetype = risk_grp), show_guide = FALSE) +
